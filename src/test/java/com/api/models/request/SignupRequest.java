...
public class SignupRequest {
	...
	/*inner class (static class) --> for builder design pattern, builder class dont have constructor,
	 * it has only methods, does not use void as a return type
	*/
	...
	public static class Builder{
		...
		public Builder username(String username) {
			this.username = username;
			Builder x = this; //instead of new Builder, which creates new object, we are using this, to point the current object
			return x;
		}
		
		public Builder password(String password) {
			this.password = password;
			return this; //this is going to return current object
		}
